...
// ==========================================
// Central Configuration Object (CENTER_DATA)
// ==========================================
const CENTER_DATA = {
  name: "مركز لؤي سعادة",
  ...
  locationDetail: "عمّان - مركز متخصص في كهرباء وميكانيك السيارات، فحص كمبيوتر، قطع غيار، وإصلاح الجير",
  googleMapsLink: "https://maps.google.com/?q=Luay+Saadeh+Center+Amman",
  workingHoursDisplay: "من السبت إلى الخميس: 9:00 ص - 7:00 م",
  workingHoursShort: "السبت - الخميس: 9 ص - 7 م",
  ...
  services: [
    {
      id: "electricity",
      title: "كهرباء سيارات",
      desc: "تشخيص وحل كافة مشاكل الكهرباء العامة، الحساسات، الضفيرة، وتتبع التماس الكهربائي بأجهزة متطورة.",
      icon: "Zap"
    },
    {
      id: "petrol-cars",
      title: "صيانة سيارات البنزين",
      desc: "صيانة وقائية وعلاجية متكاملة لسيارات البنزين تغطي المحرك، نظام الاحتراق، والوقود والبخاخات.",
      icon: "Wrench"
    },
    {
      id: "mechanic",
      title: "ميكانيك سيارات",
      desc: "أعمال الميكانيك العام للمحركات، نظام التعليق (الهيئة الأمامية)، والفرامل وصيانة الأجزاء الميكانيكية بالكامل.",
      icon: "Settings"
    },
    {
      id: "computer-scan",
      title: "فحص كمبيوتر",
      desc: "فحص كمبيوتر دقيق وشامل لجميع أنظمة السيارة وقراءة وتحليل أكواد الأعطال المخزنة في الذاكرة.",
      icon: "Cpu"
    },
    {
      id: "gear-repair",
      title: "إصلاح جير",
      desc: "تشخيص وصيانة وبرمجة جير السيارات (العادي، الأوتوماتيك، CVT) وحل مشاكل التبديل وضعف السحب.",
      icon: "Gauge"
    },
    {
      id: "spare-parts",
      title: "قطع غيار",
      desc: "توفير وتأمين قطع الغيار الأصلية والبديلة ذات الجودة العالية والمكفولة التي تناسب موديل مركبتك.",
      icon: "DollarSign"
    },
    {
      id: "engine-diag",
      title: "تشخيص أعطال السيارات",
      desc: "فحص متقدم لأسباب ضعف العزم والتقطيع (التفتفة) وصرفية البنزين الزائدة وتحديد موضع الخلل بدقة.",
      icon: "Search"
    },
    {
      id: "programming",
      title: "برمجة وفحص أنظمة السيارة",
      desc: "برمجة وتحديث أنظمة كمبيوتر السيارة الإلكترونية، برمجة الحساسات، وإعادة ضبط المصنع بعد تبديل القطع.",
      icon: "Activity"
    },
    {
      id: "hybrid-electric",
      title: "فحص سيارات هايبرد وكهرباء",
      desc: "فحص وتشخيص أنظمة الهايبرد والسيارات الكهربائية، فحص البطارية الرئيسية ونظام الشحن والإنفرتر.",
      icon: "Battery"
    }
  ],
  
  problems: [
    { title: "ظهور لمبة Check Engine", code: "P0171 / P0300" },
    { title: "ضعف عزم وتسارع السيارة", code: "Power Loss" },
    { title: "صرفية وقود زائدة عن الحد", code: "High Fuel Consumption" },
    { title: "تقطيع أو تفتفة بالمحرك", code: "Engine Misfire" },
    { title: "مشاكل وصعوبة تشغيل السيارة", code: "Start Failures" },
    { title: "أعطال الحساسات المختلفة", code: "Sensor Malfunction" },
    { title: "أعطال كمبيوتر السيارة والشبكة", code: "CAN-Bus Error" },
    { title: "مشاكل وضعف بطارية الهايبرد", code: "Hybrid Battery Issues" },
    { title: "مشاكل الشحن في السيارات الكهربائية", code: "Charging Issues" },
    { title: "مشاكل البرمجة والأنظمة الإلكترونية", code: "Coding & Configuration" }
  ],
  
  whyUs: [
    {
      title: "تشخيص دقيق قبل الإصلاح",
      desc: "نعرف أصل العطل ونحدده بدقة لكي لا تدفع ثمن قطع لا تحتاجها.",
      icon: "ShieldAlert"
    },
    {
      title: "أجهزة فحص هندسية حديثة",
      desc: "نستخدم أحدث الأجهزة المتوافقة مع كافة الموديلات الأوروبية والآسيوية والأمريكية.",
      icon: "Cpu"
    },
    {
      title: "خبرة شاملة في كافة الأنظمة",
      desc: "فريقنا مؤهل للتعامل مع سيارات البنزين، والأنظمة الهجينة (الهايبرد)، والكهربائية، والكهرباء والميكانيك العام.",
      icon: "HeartPulse"
    },
    {
      title: "توفير وقت ومال العميل",
      desc: "الفحص الصحيح من المرة الأولى ينهي المشكلة ويوفر عليك تكاليف التجارب العشوائية.",
      icon: "DollarSign"
    },
    {
      title: "تقليل الإصلاح العشوائي",
      desc: "ننهي فكرة 'جرّب غيّر ه القطعة ونشوف' التي تستنزف جيب العميل.",
      icon: "AlertTriangle"
    },
    {
      title: "توضيح وشرح كامل للعميل",
      desc: "نشرح لك المشكلة وسببها وخطوات حلها بلغة واضحة وبسيطة قبل أن نلمس السيارة.",
      icon: "CheckCircle"
    },
    {
      title: "إشراف هندسي مباشر",
      desc: "تحت إشراف مباشر من المهندس لؤي سعادة لضمان الجودة والدقة في كل خطوة.",
      icon: "Settings"
    }
  ],
  ...
  faqs: [
    {
      q: "هل تفحصون سيارات الهايبرد؟",
      a: "نعم، نحن متخصصون في فحص سيارات الهايبرد. نقوم بفحص بطارية الهايبرد وقراءة كفاءة الخلايا الفردية، فحص نظام الشحن، الإنفرتر (العاكس)، وتحديد أي عطل كهربائي بدقة بالغة."
    },
    {
      q: "هل تفحصون السيارات الكهربائية؟",
      a: "نعم بالتأكيد، نقدم فحصاً شاملاً للسيارات الكهربائية بالكامل (EV) يشمل فحص صحة البطارية (SOH)، تشخيص نظام الشحن والمداخل، قراءة الحساسات، واختبار كفاءة المحركات الكهربائية والأنظمة المساعدة."
    },
    {
      q: "هل يمكن فحص السيارة قبل الشراء؟",
      a: "نعم، نوفر خدمة الفحص الفني والتقني المتكامل للسيارات قبل الشراء. نقوم بفحص كمبيوتر شامل لجميع الأنظمة وقراءة تاريخ الأعطال المخفية لمساعدتك في معرفة الحالة الحقيقية للسيارة قبل اتخاذ قرار الشراء."
    },
    {
      q: "هل فحص الكمبيوتر يحدد سبب العطل؟",
      a: "فحص الكمبيوتر يقرأ رموز الأعطال (DTCs)، ولكن الأهم هو تحليل هذا الرمز وربطه بالحالة الميكانيكية والكهربائية الفعلية لمعرفة السبب الحقيقي للعطل وليس مجرد تبديل الحساس التالف. وهذا ما نتميز به في مركزنا."
    },
    {
      q: "هل تقدمون برمجة سيارات؟",
      a: "نعم، نوفر خدمات برمجة وتعريف قطع السيارات الجديدة، إعادة تهيئة الأنظمة (Reset)، وتحديث برمجيات كمبيوتر السيارة، وحل مشاكل لمبات التحذير بعد الصيانة."
    },
    {
      q: "كم يستغرق فحص السيارة؟",
      a: "يستغرق الفحص العادي وقراءة الكمبيوتر من 15 إلى 30 دقيقة. وفي الحالات المعقدة التي تتطلب فحص الأسلاك والظفيرة أو فحص خلايا البطارية قد يستغرق التشخيص وقتاً أطول لضمان الدقة وتجنب الخطأ."
    }
  ],
  carTypes: [
    {
      title: "السيارات الكهربائية",
      desc: "فحص وبرمجة وتشخيص أعطال السيارات الكهربائية وأنظمتها الحديثة.",
      image: "/electric.png"
    },
    {
      title: "سيارات الهايبرد",
      desc: "فحص وصيانة وبرمجة أنظمة الهايبرد وتشخيص الأعطال بدقة.",
      image: "/hybrid.png"
    },
    {
      title: "سيارات البنزين والديزل",
      desc: "صيانة وفحص وتشخيص أعطال سيارات البنزين والديزل والخدمات الميكانيكية والكهربائية.",
      image: "/defualt.png"
    }
  ]
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex-shrink-0 flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-electric-blue flex items-center justify-center text-white shadow-lg shadow-electric-blue/30 border border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-span-5 space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-electric-blue flex items-center justify-center text-white border border-white/10">
                  <Cpu className="w-5 h-5" />
                </div>
